...
class DiskStore:
  ...
  def __init__(self, directory, capacity=None):
    self.directory = pathlib.Path(directory)
    print("DiskStore directory: ", directory)
  ...
  def __getitem__(self, key):
    filename = pathlib.Path(self.filenames[key])
...
class CkptRAMStore:
  ...
  def __init__(self, directory, capacity=None):
    self.disk_store = DiskStore(directory, capacity)
